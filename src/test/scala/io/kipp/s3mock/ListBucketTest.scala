...
class ListBucketTest extends S3MockTest {
  override def behaviour(fixture: => Fixture) = {
    ...
    it should "obey delimiters && prefixes v2 (matching real s3)" ignore {
      ...
      s3.createBucket("kipp-merlin")
      s3.putObject("kipp-merlin", "sample.jpg", "xxx")
      s3.putObject("kipp-merlin", "photos/2006/January/sample.jpg", "yyy")
      s3.putObject("kipp-merlin", "photos/2006/February/sample2.jpg", "zzz")
      s3.putObject("kipp-merlin", "photos/2006/February/sample3.jpg", "zzz")
      s3.putObject("kipp-merlin", "photos/2006/February/sample4.jpg", "zzz")
      val req2 = new ListObjectsRequest()
      req2.setBucketName("kipp-merlin")
      req2.setDelimiter("/")

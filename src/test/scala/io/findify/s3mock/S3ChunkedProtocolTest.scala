...
class S3ChunkedProtocolTest extends AnyFlatSpec with Matchers {
  implicit val system: org.apache.pekko.actor.ActorSystem = ActorSystem.create("test")
  implicit val mat: org.apache.pekko.stream.ActorMaterializer= ActorMaterializer()

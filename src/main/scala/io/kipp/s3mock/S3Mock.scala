...
import io.kipp.s3mock.provider.{FileProvider, InMemoryProvider, Provider}
import io.kipp.s3mock.route._
...
class S3Mock(port: Int, provider: Provider)(implicit
  ...
  implicit val p: io.kipp.s3mock.provider.Provider = provider

...
import io.magnapinna.s3mock.provider.{FileProvider, InMemoryProvider, Provider}
import io.magnapinna.s3mock.route._
...
class S3Mock(port: Int, provider: Provider)(implicit
  ...
  implicit val p: io.magnapinna.s3mock.provider.Provider = provider
